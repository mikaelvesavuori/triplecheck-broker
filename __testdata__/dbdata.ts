export const consumerTestsLocal = [
  {
    'asdf-provider': {
      '1.0.0': [
        {
...
export const consumerTestsRemote = [
  {
    'api-provider': {
      '1.0.0': [
        {
...
export const providerContractsLocal = [
  {
    'api-provider': {
      '1.0.0': {
        definitions: {},
        $id: 'http://mikael.com/common.json',
        servers: [
          {
...
export const providerContractsRemote = [
  {
    'api-provider': {
      '1.0.0': {
        definitions: {},
...
export const brokerContractData: any = [
  {
    'api-provider': {
      '1.0.0': {
        definitions: {},
...
export const brokerTestData: any = [
  {
    'api-provider': {
      '1.0.0': [{ 'Should Take Customer': { name: 'name', email: 'email', totalPrice: 12345 } }]
    }
  }
];
